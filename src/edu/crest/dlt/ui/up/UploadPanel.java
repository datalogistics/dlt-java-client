				...
				.addGroup(
						layout
								...
								.addComponent(panel_transfer_settings, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(panel_transfer_progress, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addGroup(
										layout
					...
					for (String file_to_upload : files_to_upload) {
						try {
							...
							if (exnode_to_upload == null) {
								...
								panel_files.status_file(file_to_upload, ui_status.metadata_error);
							...
							if (exnode_to_upload.write(
								...
								panel_files.status_file(file_to_upload, ui_status.file_registering);
								...
								panel_files.status_file(file_to_upload, ui_status.transfer_sucess);
							} else {
								ui_status previousStatus = panel_files.status_file(file_to_upload);
								if (ui_status.uploading == previousStatus) {
									panel_files.status_file(file_to_upload, ui_status.upload_failed);
								} else if (ui_status.transfer_aborting == previousStatus
										|| ui_status.transfer_aborted == previousStatus) {
									panel_files.status_file(file_to_upload, ui_status.transfer_aborted);
								}
							}
						} catch (Exception e) {
