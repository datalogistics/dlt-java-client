																...
																layout
																		...
																		.addGroup(
																				layout
																						...
																						.addComponent(input_depots_all)))).addGap(2, 2, 2)));
														...
														layout
																...
																.addGroup(
																		layout
																				...
																				.addComponent(label_depots).addComponent(button_add_depot))
																.addPreferredGap(
																		javax.swing.LayoutStyle.ComponentPlacement.RELATED,
																		javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
																.addComponent(input_location,
																		...
																		javax.swing.GroupLayout.DEFAULT_SIZE,
																		javax.swing.GroupLayout.PREFERRED_SIZE))
												.addComponent(scrollpane_depots, javax.swing.GroupLayout.PREFERRED_SIZE, 0,
														Short.MAX_VALUE))));
	...
	public void sync_depots()
	{
		...
		for (Depot depot : Depot.depots()) {
			table_depots_model_default.addRow(new Object[] { false, depot,
					(depot.connected() ? icon_depot_connected : icon_depot_not_connected) });
		}
	}
