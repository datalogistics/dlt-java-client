...
public class TransferSettingsPanel extends javax.swing.JPanel
{
  ...
  private void initComponents() {
	...
	{// GEN-FIRST:event_button_add_depot_clicked
		String host_port_entered = (String) JOptionPane.showInputDialog(new JFrame(), "Depot (host:port)", null);

		if ((host_port_entered != null) && (host_port_entered.length() > 0) && host_port_entered.contains(":")) {
