...
public class DepotStatusPanel extends javax.swing.JPanel {
  ...
  private void initComponents() {
    ...
    table_depots.setModel(new javax.swing.table.DefaultTableModel(
      ...
      new String [] {
        "Depot(s)", "Status", "Success", "Fail", "Connection(s)", "Throughput"
      }
    ) {
    ...
    if (table_depots.getColumnModel().getColumnCount() > 0) {
      table_depots.getColumnModel().getColumn(1).setMinWidth(40);
      table_depots.getColumnModel().getColumn(1).setPreferredWidth(40);
      table_depots.getColumnModel().getColumn(1).setMaxWidth(40);
      table_depots.getColumnModel().getColumn(1).setCellRenderer(new edu.crest.dlt.ui.up.TransferSettingsPanel.ConnectionStatusRenderer());
...
//  	depots_sorted.sort(null);
		for (Depot depot : depots_sorted) {
			table_depots_model_default.addRow(new Object[] { depot,
  ...
  private static final int column_index_depot = 0;
	private static final int column_index_status = 1;
	private static final int column_index_success = 2;
	private static final int column_index_fail = 3;
	private static final int column_index_connections = 4;
